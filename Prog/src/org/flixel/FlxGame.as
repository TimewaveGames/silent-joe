package org.flixel
{
	...
	public class FlxGame extends Sprite
	{
		...
		internal var _waitingConf:Boolean = false;
		...
		public function showSoundTray(Silent:Boolean=false):void
		{
			...
			//text.text = LanguagePack.VOLUME[FlxG.language];
		...
		protected function onKeyUp(event:KeyboardEvent):void
		{
			...
			if(useDefaultHotKeys)
			{
				...
				switch(c)
				{
					...
					case 27:
					case 80:
						if (!(FlxU.getClassName(FlxG.state) == "Silent.MainMenu") && !pause.isMochi() && !(FlxU.getClassName(FlxG.state) == "Silent.EndAnimation") && !(FlxU.getClassName(FlxG.state) == "Silent.SplashScreen") && !FlxG.enduEnd) FlxG.pause = !FlxG.pause; 
						break;
					case 76:
						if (FlxG.pause) {
							pause.createPanel();
		...
		{
			if (FlxG.pause && (FlxU.getClassName(FlxG.state) == "Silent.MainMenu")) FlxG.pause = false; pause.hideBg(true);
		}
		...
		{
			if (!(FlxU.getClassName(FlxG.state) == "Silent.EndAnimation") && !(FlxU.getClassName(FlxG.state) == "Silent.SplashScreen")) FlxG.pause = true;
			if (FlxU.getClassName(FlxG.state) == "Silent.MainMenu") pause.hideBg(false);
		}
