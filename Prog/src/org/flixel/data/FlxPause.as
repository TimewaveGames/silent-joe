package org.flixel.data
{
	...
	public class FlxPause extends FlxGroup
	{
		...
		public function openMochi():void {
			...
			if (FlxU.getClassName(FlxG.state) == "Silent.EnduState") {
				o = { n: [0, 3, 8, 10, 13, 1, 9, 2, 2, 2, 11, 12, 11, 2, 1, 11], f: function (i:Number,s:String):String { if (s.length == 16) return s; return this.f(i+1,s + this.n[i].toString(16));}};
				boardID = o.f(0,"");
				MochiScores.showLeaderboard( { boardID: boardID, score: RunnerState.scoreGame, onClose:mochiClose, onDisplay:mochiDisplay } );
			}else {
				o = { n: [11, 8, 13, 4, 8, 0, 15, 5, 15, 1, 12, 9, 11, 13, 11, 3], f: function (i:Number,s:String):String { if (s.length == 16) return s; return this.f(i+1,s + this.n[i].toString(16));}};
				boardID = o.f(0,"");
				MochiScores.showLeaderboard( { boardID: boardID, score: RunnerState.scoreGame, onClose:mochiClose, onDisplay:mochiDisplay } );
			}
		}
